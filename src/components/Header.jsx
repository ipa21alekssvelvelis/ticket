...
function Header() {
    ...
    return (
        <>
            <div className="w-screen h-[10vh] bg-[rgb(10,10,10,0.05)] flex justify-between items-center z-50 absolute top-0">
            ...
            <div className={`w-screen h-screen fixed top-0 left-0 bg-black bg-opacity-40 z-40 transition-opacity duration-300 ${isMobileMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}></div>
            <div className={`w-full overflow-y-scroll sm:w-[40%] lg:w-[30%] h-screen fixed top-0 left-0 z-50 flex text-white flex-col items-center justify-center bg-[rgb(18,18,18,0.97)] overflow-hidden transition-transform transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                        ...
                        <div className=" w-full flex mb-2 flex-col items-center">
                            <div className="flex items-center justify-center w-full flex-col md:flex-row lg:flex-row sm:flex-row md:ml-12 sm:ml-12 lg:ml-12">
                                ...
                                <div className="w-full sm:text-start text-center">
                                    <Link to="/" className="text-3xl text-white font-light uppercase tracking-widest cursor-pointer text-center sm:text-left sm:ml-8 md:text-left md:ml-8 lg:text-left lg:ml-8">Home</Link> 
                                </div>
                            </div>
                        </div>
                        <div className="w-full flex mb-2 flex-col items-center">
                            <div className="flex items-center w-full flex-col md:flex-row lg:flex-row sm:flex-row md:ml-12 sm:ml-12 lg:ml-12">
                                <Link to="/Events" className="flex p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 my-2">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" />
                                    </svg>
                                </Link>
                                <div className="w-full sm:text-start text-center">
                                    <Link to="/Events"  className="text-3xl text-white font-light uppercase tracking-widest cursor-pointer text-center sm:text-left sm:ml-8 md:text-left md:ml-8 lg:text-left lg:ml-8">EVENTS</Link> 
                                </div>
                            </div>
                        </div>
                        {isLoggedIn && 
                            <div className=" w-full flex mb-2 flex-col items-center">
                                <div className="flex items-center w-full flex-col md:flex-row lg:flex-row sm:flex-row md:ml-12 sm:ml-12 lg:ml-12">
                                    <Link to="/PurchaseHistory" className="flex p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 my-2">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                                        </svg>
                                    </Link>
                                    <div className="w-full">
                                        <Link to="/PurchaseHistory" className="text-3xl text-white font-light uppercase tracking-widest cursor-pointer text-center sm:text-left sm:ml-8 md:text-left md:ml-8 lg:text-left lg:ml-8">Purchases</Link> 
                                    </div>
                                </div>
                            </div>
                        }
