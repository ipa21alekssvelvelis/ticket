...
function PaymentForm({onClose, ticketList}){
    ...
    return(
        ...
        <div className='w-full flex justify-center items-center align-center fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30'>
            <div className='w-[315px] bg-[rgb(24,24,24,1)] min-h-[600px] text-white sm:w-[50%]  min-h-[300px] border-2 border-green-500 z-30 my-2 flex flex-col'>
                <div className='w-full h-full flex flex-col'>
                    <div className='w-full h-[10%] flex flex-col items-center relative'>
                        <h1 className='my-8 sm:my-1 uppercase font-light text-2xl md:text-4xl lg:text-4xl xl:text-4xl tracking-widest'>Pay for your ticket</h1>
